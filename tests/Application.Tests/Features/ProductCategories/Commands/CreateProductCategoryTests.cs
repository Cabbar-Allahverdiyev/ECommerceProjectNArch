...
using Xunit;
using static Application.Features.ProductCategories.Commands.Create.CreateProductCategoryCommand;

namespace Application.Tests.Features.ProductCategories.Commands;
public class CreateProductCategoryTests : ProductCategoryMockRepository
{
    ...
    public CreateProductCategoryTests(ProductCategoryFakeData fakeData,
                                      CreateProductCategoryCommandValidator validator,
                                      CreateProductCategoryCommand command) :base(fakeData)
    {
    ...
    {
        _command.Name = "Dam ortuk";
        _command.Description = "Ela endirim";
        CreatedProductCategoryResponse result = await _handler.Handle(_command, CancellationToken.None);
        Assert.Equal(expected: "Dam ortuk", result.Name);
