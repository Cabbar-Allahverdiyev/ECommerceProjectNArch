...
public class UserOperationClaimBusinessRules : BaseBusinessRules
{
    ...
    public Task UserOperationClaimShouldExistWhenSelected(UserOperationClaim? userOperationClaim)
    {
        if (userOperationClaim == null)
            throw new BusinessException(UserOperationClaimsBusinessMessages.UserOperationClaimNotExists);
    ...
    {
        if (userOperationClaim != null)
            throw new BusinessException(UserOperationClaimsBusinessMessages.UserOperationClaimAlreadyExists);
        return Task.CompletedTask;
    }
